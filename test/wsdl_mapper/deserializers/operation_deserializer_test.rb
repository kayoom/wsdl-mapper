...
PriceInlineTypeDeserializer = TypeDirectory.register_type(['http://example.org/schema#inline-types', 'PriceInlineType'], PriceInlineType, simple: ['http://www.w3.org/2001/XMLSchema', 'double']) do
  register_attr(:currency, ['http://example.org/schema#inline-types', 'Currency'], ['http://www.w3.org/2001/XMLSchema', 'string'])
end
OutputBodyDeserializer = TypeDirectory.register_type(['http://schemas.xmlsoap.org/soap/envelope/', 'Body'], OutputBody) do
  register_prop(:price, ['http://example.org/schema', 'Price'], ['http://example.org/schema#inline-types', 'PriceInlineType'])
